...
<div class="container">
  ...
  <div class="card" style="width:500px">
    <img class="card-img-top" src="leave.jpg" alt="Card image" style="width:45%">
    <div class="card-body">
      <h4 class="card-title">Leave Application</h4>
      <p class="card-text">
          <form method="post" action="/addqry1" style="width: 55%;">
      <input type="hidden" name="_token" value="{{ csrf_token() }}">

      <label>Employee Name</label>
      <input type="text" name="enm" class="form-control"><br>
      <label>Emploee Id</label>
      <input type="text" name="eno" class="form-control"><br>
      <label>Type of leave</label>
     <input list="Type" name="Type" class="form-control">
  <datalist id="Type">
  ...
  <br><br>
      <label>From</label>
      <input type="text" name="fr" class="form-control"><br>
      <label>To</label>
