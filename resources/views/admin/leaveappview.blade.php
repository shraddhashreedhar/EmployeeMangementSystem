...
<body>
  ...
  <table class="table table-bordered">
      ...
      <tr>
         ...
         <td><a href="/approve/{{ $items->id}}"> <input type="submit" name="add" class="btn btn-info" value="Approve"></a></td>
          <td><a href="/reject/{{ $items->id}}"><input type="submit" name="add" class="btn btn-info" value="Reject"></a></td>
         </tr>
